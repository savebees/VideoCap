...
[
  {
    ...
    "task": "global_short",
    "question": "视频中发生了什么？",
    "answer": "大兔子在昏暗的洞穴中醒来，走进明亮的草地，感受清晨、嗅闻一簇白花，并注意到一只紫色蝴蝶。",
  ...
  },
  {
    ...
    "task": "global_camera",
    "question": "视频采用了怎样的拍摄方式？",
    "answer": "视频以洞穴的固定远景开场，在兔子醒来时切至特写，随后用中景和低角度镜头记录它走出洞穴并伸展身体，再交替使用面部与花朵特写、越肩草地镜头和高角度镜头，跟随它将注意力转向蝴蝶。",
    "provenance": {"event_ids": ["event_0000", "event_0001", "event_0002", "event_0003", "event_0004"], "evidence_frames_ms": []}
  },
  {
    "qa_id": "bbb-0038-0078__event_0004",
    "task": "temporal_event",
    "question": "33000 毫秒到 40000 毫秒期间发生了什么？",
    "answer": "一只紫色蝴蝶在花旁飞舞。兔子注意到它，将视线移向草地，并跟随蝴蝶移动，视频以高角度镜头结束。",
